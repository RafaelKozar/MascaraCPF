...
public class MaskGenerica2 {
    ...
    public static int getCursor10Digitos(int cursor, String editTextString, String str, String old) {
        ...
        if ((cursor == 1 || cursor == 3 || cursor == 4 || cursor == 8 || cursor == 9 ||
                ((cursor == 2 || cursor == 5 || cursor == 6 || cursor == 7 || cursor == 11) && !withMask)) && inclusao) {
            if (!withMask && cursor != 1) {
                if (cursor == 5 || cursor == 6 || cursor == 7 || cursor == 8 || cursor == 9 || cursor == 11)
                    cursor++;
                cursor++;
            }
            cursor++;
                ...
                && !inclusao) {
            if(cursor == 12 || cursor == 11 || cursor == 10 || cursor == 9) cursor -= 3;
            else if (cursor == 8 || cursor == 5 || cursor == 4) cursor -= 2;
            else cursor--;
        }
